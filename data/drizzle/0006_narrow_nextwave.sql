...
CREATE TABLE `__new_links` (
	...
	`created_at` text DEFAULT 'Tue Feb 25 2025 16:31:16 GMT-0300 (Horário Padrão de Brasília)',
	`title` text,
	`url` text NOT NULL,
	`description` text,
	`image` text,
...
ALTER TABLE `pages` ALTER COLUMN "created_at" TO "created_at" text DEFAULT 'Tue Feb 25 2025 16:31:16 GMT-0300 (Horário Padrão de Brasília)';--> statement-breakpoint
